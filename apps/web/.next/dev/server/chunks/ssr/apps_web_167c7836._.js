...
"[project]/apps/web/app/projects/[id]/sites/import/actions.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"6052c7a0af490cc651cd4b04fc36218902eaec741e":"commitImportAction","60f3fc9d04c5e8eecd009d294a124b24d9f3919f00":"previewImportAction"},"",""] */ __turbopack_context__.s([
    "commitImportAction",
    ()=>commitImportAction,
    "previewImportAction",
    ()=>previewImportAction
...
;
;
async function previewImportAction(_previous, form) {
    const projectId = String(form.get('projectId'));
    const file = form.get('file');
    if (!(file instanceof File) || file.size === 0) return {
        error: 'Choose a .xlsx file to preview.'
    };
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$lib$2f$project$2d$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["previewSiteImport"])(projectId, file);
    ...
    const state = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$projects$2f$settle$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["settle"])(result, `/projects/${projectId}/sites/import`);
    if (state.error) return state;
    return result.state === 'ready' ? {
        preview: result.data
    } : state;
}
async function commitImportAction(_previous, form) {
    const projectId = String(form.get('projectId'));
    ...
    if (!payload) return {
        error: 'Fix the file and preview it again before importing.'
    };
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$lib$2f$project$2d$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["commitSiteImport"])(projectId, payload);
    const state = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$projects$2f$settle$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["settle"])(result, `/projects/${projectId}`);
    if (state.error) return state;
    return result.state === 'ready' ? {
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_$40$babel$2b$core$40$7$2e$29$2e$7_$40$opentelemetry$2b$api$40$1$2e$9$2e$1_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(previewImportAction, "60f3fc9d04c5e8eecd009d294a124b24d9f3919f00", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$7_$40$babel$2b$core$40$7$2e$29$2e$7_$40$opentelemetry$2b$api$40$1$2e$9$2e$1_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(commitImportAction, "6052c7a0af490cc651cd4b04fc36218902eaec741e", null);
}),
...
"[project]/apps/web/.next-internal/server/app/projects/[id]/sites/import/page/actions.js { ACTIONS_MODULE0 => \"[project]/apps/web/app/projects/[id]/sites/import/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/apps/web/app/projects/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$projects$2f5b$id$5d2f$sites$2f$import$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/app/projects/[id]/sites/import/actions.ts [app-rsc] (ecmascript)");
...
"[project]/apps/web/.next-internal/server/app/projects/[id]/sites/import/page/actions.js { ACTIONS_MODULE0 => \"[project]/apps/web/app/projects/[id]/sites/import/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/apps/web/app/projects/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "6052c7a0af490cc651cd4b04fc36218902eaec741e",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$projects$2f5b$id$5d2f$sites$2f$import$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["commitImportAction"],
    ...
    "60f3fc9d04c5e8eecd009d294a124b24d9f3919f00",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$projects$2f5b$id$5d2f$sites$2f$import$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["previewImportAction"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f2e$next$2d$internal$2f$server$2f$app$2f$projects$2f5b$id$5d2f$sites$2f$import$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$apps$2f$web$2f$app$2f$projects$2f5b$id$5d2f$sites$2f$import$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$apps$2f$web$2f$app$2f$projects$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/apps/web/.next-internal/server/app/projects/[id]/sites/import/page/actions.js { ACTIONS_MODULE0 => "[project]/apps/web/app/projects/[id]/sites/import/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE1 => "[project]/apps/web/app/projects/actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$projects$2f5b$id$5d2f$sites$2f$import$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/app/projects/[id]/sites/import/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$app$2f$projects$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/app/projects/actions.ts [app-rsc] (ecmascript)");
}),
];

//# sourceMappingURL=apps_web_167c7836._.js.map