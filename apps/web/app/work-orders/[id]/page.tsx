...
import { getWorkOrder, listAssignable, type WorkOrderEvent } from '../../lib/project-api';
...
export default async function WorkOrderPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (order.state !== 'ready') {
    return <StatePage title="Cannot show this work order"><p>{order.message}</p><p className="subtle"><a href="/work-orders">Back to work orders</a></p></StatePage>;
  }
  const wo = order.data;
