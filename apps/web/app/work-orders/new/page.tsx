  ...
  if (!may('task.create') || !may('task.assign')) {
    return (
      <StatePage title="Your account cannot assign work orders">
        ...
        <p className="subtle"><a href="/work-orders">Back to work orders</a></p>
      </StatePage>
    );
  }
    ...
    <main className="app-shell">
      ...
      <section className="content">
        <header className="topbar">
          <div className="crumbs"><a href="/work-orders">Work orders</a><b>/</b><strong>Assign a checklist</strong></div>
          <TopActions />
        </header>
