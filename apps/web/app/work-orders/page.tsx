...
export default async function WorkOrdersPage({ searchParams }: { searchParams: Promise<QueueSearch> }) {
  ...
  const newHref = queue.params.projectId ? `/work-orders/new?projectId=${queue.params.projectId}` : '/work-orders/new';
      ...
      <section className="content">
        ...
        <div className="dashboard">
          ...
          <section className="panel">
            <WorkOrderQueue data={result.data} params={queue.params} basePath="/work-orders" projects={choices} names={queue.names} now={new Date()} created={queue.created} />
          </section>
        </div>
      </section>
    </main>
